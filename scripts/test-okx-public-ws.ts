import { OkxPublicWsGateway, OkxWsDataEnvelope, OkxWsRawMessage } from "../src/services/okx";
import { getDefaultOkxPublicSubscriptions } from "../src/services/okx/config";

const gateway = new OkxPublicWsGateway({
  logger: {
...
const subscriptions = getDefaultOkxPublicSubscriptions();
const liveData = new Set<string>();

const stop = setTimeout(() => {
  console.error("WebSocket 烟雾测试超时");
